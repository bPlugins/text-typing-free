=== Typing Text – Animated Typing Effect Block for Headings & Text ===
Contributors: bplugins, noornabi2, abuhayat, charlescormier
Donate link: https://www.buymeacoffee.com/abuhayat
Tags: block, typing text, typing effect, text animation, typing animation
...
- **Typing Controls**: Configure Type Speed, Start Delay, Back Speed, Back Delay, Shuffle, Fade Out Effect, Loop, and Cursor.
...
- **Layout & Styling**: Control alignment, width, padding, border, and background.
...
=== Text Typing Pro – Unlock Premium Themes & Effects ===
[Text Typing Pro](https://bplugins.com/products/text-typing/pricing/) is a separate plugin that extends Typing Text with ready-made animated themes and advanced styling.
...
- **Icons for Each Text**: Add icons before or after the typing text.
- **Icon Customization**: Set icon size and appearance.
...
[Get Text Typing Pro](https://bplugins.com/products/text-typing/pricing/) – Unlock all premium themes and effects now!
...
- Search for "Text Typing".
- Insert the block into your page.

== Configure the Typing ==

- Add your prefix, one or more typing lines, and suffix text.
- Adjust Type Speed, Start Delay, Back Speed, Back Delay, Shuffle, Fade Out, Loop, and Cursor.
...
- **Update**: Update Pro modal about unlock features added.
